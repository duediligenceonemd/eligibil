...
async function extract(text, opts = {}) {
  ...
  result.relevance_score = scoreRelevance(result.grant);
  // Parse arrays
...
function scoreRelevance(g) {
  ...
  // Eligibility (assume SRL/startup-friendly)
...
module.exports = { extract, computeFingerprint, scoreRelevance, extractWithClaude, extractHeuristic };
